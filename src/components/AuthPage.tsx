    ...
    return (
      <div className="w-full max-w-sm space-y-6 text-center animate-fade-in">
        ...
        <div className="space-y-3">
          <Button onClick={() => handleOAuth("google")} disabled={loading} variant="outline" className="w-full h-12 text-base gap-2">
          ...
          <Button onClick={() => handleOAuth("apple")} disabled={loading} variant="outline" className="w-full h-12 text-base gap-2">
